...
public class OpcantC extends JPanel {
	 ...
	 * Create the panel.
	 */
	public OpcantC(JPanel panelops, Admin due) {
		...
		txtIngresanombre.setText("Ingresa el nombre del curso\r\n");
		...
		txtIngresacant.setText("Ingresa las nuevas existencias de los cursos");
		...
		lblNewLabel_1 = new JLabel("Establecer cantidad");
		...
		lblNewLabel_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				boolean ban = true; 
				try {
					Integer.parseInt(txtIngresacant.getText());
				} catch (Exception e2) {
					JOptionPane.showMessageDialog(null, "Ingresa información valida");
					ban = false;
				}
				
				if (ban) {
					try {
						due.setInventario(B.Modificar_Cantidad(due.getInventario(), txtIngresanombre.getText(),  Integer.parseInt(txtIngresacant.getText())));
		...
		JLabel lblNewLabel = new JLabel("Cantidad de ese curso");
