...
public class OpIngresar extends JPanel {
	 ...
	 * Create the panel.
	 */
	public OpIngresar(JPanel panelops, int id) {
		...
		lblNewLabel_1 = new JLabel("Guardar información");
		...
		lblNewLabel_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					a.add(duenio);
					logica.Ingresar(a);
					logica.EscribirArchivo(txtIngresaElNombre.getText());
					panelops.removeAll();
					panelops.revalidate();
					panelops.repaint();
				} catch (Exception e2) {
		...
		JLabel lblNewLabel = new JLabel("Ingresar información");
